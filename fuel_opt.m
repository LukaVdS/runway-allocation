...
Cost_f = 1; % kg of kerosene/flight
% Distance * MassFlow / Vtas   ( need Time ?)
% assume only aircraft D = 4NM to runway threshold: Vtas = 160Kts (indicated)
% Massflow = ??, depends on class M or H.

Cost_f = ones(10*2*6, 1)*100;
